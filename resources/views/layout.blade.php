...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="{{asset('fronend/images/ico/apple-touch-icon-57-precomposed.png')}}">
</head><!--/head-->
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <div class="col-sm-6">
                                ...
                                <img src="{{asset('frontend/ages/home/pricing.png')}}"  class="pricing" alt="" />
                            </div>
                        </div>
                        <div class="item">
                            <div class="col-sm-6">
